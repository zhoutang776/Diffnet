...
void dpm(double * Sigma, double * omg, int *dd, int *diags, double * lambda, int *nnlambda, double * gamma, int * max_ite, double * prec, double * e_i, double * num_iter)
{
